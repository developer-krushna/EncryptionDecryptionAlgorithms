...
* Recreated by Maharna's Tech (Subscribe Maharna's Tech youtube channel and learn how to mod app using MT Manager)
*/

public class WingdingMT extends mt.base_converter.interfaces.MTImpl {
	...
	public String decode(@NonNull String text) {
		...
		loop:
		for (Integer codePoint : MTUtil.codePoints(text)) {
